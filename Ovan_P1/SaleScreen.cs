    ...
    public partial class SaleScreen : Form
    {
        ...
        private void CreateCategoryList(FlowLayoutPanel listPanel)
        {
            ...
            while (sqlite_datareader.Read())
            {
                ...
                if (saleFlag)
                {
                    ...
                    int btnHeight = listPanel.Height / 5 - 10;
        ...
        private void CreateProductsList11()
        {
            ...
            for (int i = 0; i < selectedCategoryLayout; i++)
            {
                ...
                if (i == 0)
                {
                    p = createPanel.CreatePanelForProducts(this, 0, 0, nWidth, nHeight, i.ToString(), true, borderClr, Color.White);
                    BackgroundBitmap = new Bitmap(nWidth, nHeight);
                    p.Paint += new PaintEventHandler(panelbordercolor2_Paint);
                }
                else if (i == 1)
                {
                    p = createPanel.CreatePanelForProducts(this, nWidth + 20, 0, nWidth2, nHeight2, i.ToString(), true, borderClr, Color.White);
                ...
                else if (i == 2 || i == 6 || i == 10)
                {
                    ...
                    if (i == 6) hh = 3 * h1 + 60;
                    if (i == 10) hh = 4 * h1 + 80;
                    p = createPanel.CreatePanelForProducts(this, nWidth + 20, hh, nWidth3, nHeight3, i.ToString(), true, borderClr, Color.White);
                    BackgroundBitmap = new Bitmap(nWidth3, nHeight3);
                    p.Paint += new PaintEventHandler(panelbordercolor4_Paint);
                }
                else if (i < 6)
                {
                    p = createPanel.CreatePanelForProducts(this, (i - 3) * w1 + (i - 3) * 20, nHeight + 20, w1, h1, i.ToString(), true, borderClr, Color.White);
                    BackgroundBitmap = new Bitmap(w1, h1);
                    p.Paint += new PaintEventHandler(panelbordercolor_Paint);
                }
                else
                {
                    p = createPanel.CreatePanelForProducts(this, (i - 7) * w1 + (i - 7) * 20, nHeight + h1 + 40, w1, h1, i.ToString(), true, borderClr, Color.White);
                    BackgroundBitmap = new Bitmap(w1, h1);
                    p.Paint += new PaintEventHandler(panelbordercolor_Paint);
                }
        ...
        private void CreateProductsList13()
        {
            ...
            for (int i = 0; i < selectedCategoryLayout; i++)
            {
                ...
                if (i == 0 || i == 1)
                {
                    p = createPanel.CreatePanelForProducts(this, i * (2 * w1 + 20) + i * 20, 0, 2 * w1 + 20, 2 * h1 + 20, i.ToString(), true, borderClr, Color.White);
                    BackgroundBitmap = new Bitmap(2 * w1 + 20, 2 * h1 + 20);
                    p.Paint += new PaintEventHandler(panelbordercolor2_Paint);
                }
                else if (i == 2 || i == 3)
                {
                    p = createPanel.CreatePanelForProducts(this, 2 * (2 * w1 + 20) + 2 * 20, (i - 2) * (h1 + 20), w1, h1, i.ToString(), true, borderClr, Color.White);
                    BackgroundBitmap = new Bitmap(w1, h1);
                    p.Paint += new PaintEventHandler(panelbordercolor_Paint);
                }
                else if (i == 4 || i == 5)
                {
                    p = createPanel.CreatePanelForProducts(this, (i - 4) * (2 * w1 + 20) + (i - 4) * 20, 2 * h1 + 40, 2 * w1 + 20, 2 * h1 + 20, i.ToString(), true, borderClr, Color.White);
                    BackgroundBitmap = new Bitmap(2 * w1 + 20, 2 * h1 + 20);
                    p.Paint += new PaintEventHandler(panelbordercolor2_Paint);
                }
                else if (i == 6 || i == 7)
                {
                    p = createPanel.CreatePanelForProducts(this, 2 * (2 * w1 + 20) + 2 * 20, (i - 4) * (h1 + 20), w1, h1, i.ToString(), true, borderClr, Color.White);
                    BackgroundBitmap = new Bitmap(w1, h1);
                    p.Paint += new PaintEventHandler(panelbordercolor_Paint);
                }
                else
                {
                    p = createPanel.CreatePanelForProducts(this, (i - 8) * w1 + (i - 8) * 20, 2 * (2 * h1 + 40), w1, h1, i.ToString(), true, borderClr, Color.White);
                    BackgroundBitmap = new Bitmap(w1, h1);
                    p.Paint += new PaintEventHandler(panelbordercolor_Paint);
                }
        ...
        private void CreateProductsList()
        {
            ...
            for (int i = 0; i < selectedCategoryLayout; i++)
            {
                ...
                BackgroundBitmap = null;
                Panel p = createPanel.CreatePanelForProducts(this, x * (w1 + d), yy * (h1 + 20), w1, h1, i.ToString(), true, borderClr, Color.White);
                BackgroundBitmap = new Bitmap(w1, h1);
                borderPen = new Pen(borderClr, 3);
                p.Paint += new PaintEventHandler(panelbordercolor_Paint);
