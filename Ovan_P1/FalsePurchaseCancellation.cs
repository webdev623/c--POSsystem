    ...
    public partial class FalsePurchaseCancellation : Form
    {
        ...
        public FalsePurchaseCancellation(Form1 mainForm, Panel mainPanel)
        {
           ...
           // yearLabel1.Margin = new Padding(5, 0, 0, 0);
            ...
            ComboBox monthCombobox1 = createCombobox.CreateComboboxs(bodyDownPanel, "monthCombobox1", constants.months1, startLabel.Right + 270, subTitle2.Bottom + 40, 150, 40, 25, new Font("Comic Sans", 18));
            ...
            ComboBox dateCombobox1 = createCombobox.CreateComboboxs(bodyDownPanel, "dateCombobox1", constants.dates1, startLabel.Right + 500, subTitle2.Bottom + 40, 150, 40, 25, new Font("Comic Sans", 18));
            ...
            // dropDownMonth.CreateDropDown("falsePurchaseCancellation", bodyDownPanel, constants.months, startLabel.Right + 230, subTitle2.Bottom + 30, 150, 50, 150, 50 * 13, 150, 50, Color.Transparent, Color.Transparent);
            ComboBox monthCombobox2 = createCombobox.CreateComboboxs(bodyDownPanel, "monthCombobox2", constants.months2, startLabel.Right + 270, startLabel.Bottom + 40, 150, 40, 25, new Font("Comic Sans", 18));
            ...
            //  dropDownDate.CreateDropDown("falsePurchaseCancellation", bodyDownPanel, constants.dates, startLabel.Right + 440, subTitle2.Bottom + 30, 150, 50, 150, 50 * 32, 150, 50, Color.Transparent, Color.Transparent);
            ComboBox dateCombobox2 = createCombobox.CreateComboboxs(bodyDownPanel, "dateCombobox2", constants.dates2, startLabel.Right + 500, startLabel.Bottom + 40, 150, 40, 25, new Font("Comic Sans", 18));
